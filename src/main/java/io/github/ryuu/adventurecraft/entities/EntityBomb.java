...
public class EntityBomb extends ItemEntity {
    ...
    public EntityBomb(Level world, Entity entity) {
        ...
        this.velocityX = 0.3 * -Math.sin(this.yaw / 180.0f * 3.141593f) * Math.cos(this.pitch / 180.0f * 3.141593f);
        this.velocityZ = 0.3 * Math.cos(this.yaw / 180.0f * 3.141593f) * Math.cos(this.pitch / 180.0f * 3.141593f);
        this.velocityY = 0.3 * -Math.sin(this.pitch / 180.0f * 3.141593f) + (double) 0.1f;
    ...
    public static void explode(Entity exploding, Entity parentEntity, Level worldObj, double posX, double posY, double posZ) {
        ...
        for (double x = -3; x <= 3; ++x) {
            for (Double y = (double) -3; y <= 3; ++y) {
                for (Double z = (double) -3; z <= 3; ++z) {
