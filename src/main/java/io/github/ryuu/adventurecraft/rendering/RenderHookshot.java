...
public class RenderHookshot extends EntityRenderer {
    ...
    public void doRenderFish(EntityHookshot entityHookshot, double d, double d1, double d2, float f, float f1) {
        ...
        GL11.glRotatef((float) (entityHookshot.prevYaw + (entityHookshot.yaw - entityHookshot.prevYaw) * f1 - 90.0f), 0.0f, 1.0f, 0.0f);
        GL11.glRotatef((float) (entityHookshot.prevPitch + (entityHookshot.pitch - entityHookshot.prevPitch) * f1), 0.0f, 0.0f, 1.0f);
