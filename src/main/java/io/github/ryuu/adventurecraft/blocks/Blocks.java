...
public class Blocks {
    ...
    static {
        ...
        gm.c[pillarStone.bn] = (new ItemSubtypes(pillarStone.bn - 256)).a("pillarStone");
        gm.c[pillarMetal.bn] = (new ItemSubtypes(pillarMetal.bn - 256)).a("pillarMetal");
        gm.c[plant1.bn] = (new ItemSubtypes(plant1.bn - 256)).a("flower");
        gm.c[trees.bn] = (new ItemSubtypes(trees.bn - 256)).a("sapling");
        gm.c[glassBlocks.bn] = (new ItemSubtypes(glassBlocks.bn - 256)).a("glass");
        gm.c[cageBlocks.bn] = (new ItemSubtypes(cageBlocks.bn - 256)).a("cage");
        gm.c[stoneBlocks1.bn] = (new ItemSubtypes(stoneBlocks1.bn - 256)).a("stone");
        gm.c[stoneBlocks2.bn] = (new ItemSubtypes(stoneBlocks2.bn - 256)).a("stone");
        gm.c[stoneBlocks3.bn] = (new ItemSubtypes(stoneBlocks3.bn - 256)).a("stone");
        gm.c[woodBlocks.bn] = (new ItemSubtypes(woodBlocks.bn - 256)).a("wood");
        gm.c[halfSteps1.bn] = (new ItemSubtypes(halfSteps1.bn - 256)).a("halfStep");
        gm.c[halfSteps2.bn] = (new ItemSubtypes(halfSteps2.bn - 256)).a("halfStep");
        gm.c[halfSteps3.bn] = (new ItemSubtypes(halfSteps3.bn - 256)).a("halfStep");
        gm.c[tableBlocks.bn] = (new ItemSubtypes(tableBlocks.bn - 256)).a("table");
        gm.c[chairBlocks1.bn] = (new ItemSubtypes(chairBlocks1.bn - 256)).a("chair");
        gm.c[chairBlocks2.bn] = (new ItemSubtypes(chairBlocks2.bn - 256)).a("chair");
        gm.c[ropes1.bn] = (new ItemSubtypes(ropes1.bn - 256)).a("rope");
        gm.c[ropes2.bn] = (new ItemSubtypes(ropes2.bn - 256)).a("rope");
        gm.c[chains.bn] = (new ItemSubtypes(chains.bn - 256)).a("chain");
        gm.c[ladders1.bn] = (new ItemSubtypes(ladders1.bn - 256)).a("ladder");
        gm.c[ladders2.bn] = (new ItemSubtypes(ladders2.bn - 256)).a("ladder");
        gm.c[ladders3.bn] = (new ItemSubtypes(ladders3.bn - 256)).a("ladder");
        gm.c[ladders4.bn] = (new ItemSubtypes(ladders4.bn - 256)).a("ladder");
        gm.c[lights1.bn] = (new ItemSubtypes(lights1.bn - 256)).a("torch");
        gm.c[plant2.bn] = (new ItemSubtypes(plant2.bn - 256)).a("flower");
        gm.c[plant3.bn] = (new ItemSubtypes(plant3.bn - 256)).a("flower");
        gm.c[overlay1.bn] = (new ItemSubtypes(overlay1.bn - 256)).a("overlay");
        gm.c[stairs1.bn] = (new ItemSubtypes(stairs1.bn - 256)).a("stairs");
        gm.c[stairs2.bn] = (new ItemSubtypes(stairs2.bn - 256)).a("stairs");
        gm.c[stairs3.bn] = (new ItemSubtypes(stairs3.bn - 256)).a("stairs");
        gm.c[stairs4.bn] = (new ItemSubtypes(stairs4.bn - 256)).a("stairs");
        gm.c[slopes1.bn] = (new ItemSubtypes(slopes1.bn - 256)).a("slopes");
        gm.c[slopes2.bn] = (new ItemSubtypes(slopes2.bn - 256)).a("slopes");
        gm.c[slopes3.bn] = (new ItemSubtypes(slopes3.bn - 256)).a("slopes");
        gm.c[slopes4.bn] = (new ItemSubtypes(slopes4.bn - 256)).a("slopes");
        for (int i = 0; i < 256; i++) {
            if (Tile.m[i] != null && gm.c[i] == null) {
                gm.c[i] = new ck(i - 256);
                Tile.m[i].k();
            }
        }
