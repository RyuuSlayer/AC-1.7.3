...
public class MixinChunk {
    ...
    public MixinTileEntity getTileEntity(int x, int y, int z) {
        ...
        MixinTileEntity tileentity = (MixinTileEntity) this.tileEntities.get((Object) chunkposition);
        if (tileentity == null) {
            ...
            tileentity = (MixinTileEntity) this.tileEntities.get((Object) chunkposition);
        }
    ...
    public void removeTileEntity(int x, int y, int z) {
        ...
        TilePos chunkposition = new TilePos(x, y, z);
        if (this.field_955 && (tileentity = (MixinTileEntity) this.tileEntities.remove((Object) chunkposition)) != null) {
    ...
    public int fillChunkData(byte[] byArray, int n, int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        if (n12 * n13 * n14 == this.tiles.length) {
            System.arraycopy((Object) this.tiles, (int) 0, (Object) byArray, (int) n7, (int) this.tiles.length);
            System.arraycopy((Object) this.meta.data, (int) 0, (Object) byArray, (int) (n7 += this.tiles.length), (int) this.meta.data.length);
            System.arraycopy((Object) this.blocklight.data, (int) 0, (Object) byArray, (int) (n7 += this.meta.data.length), (int) this.blocklight.data.length);
            System.arraycopy((Object) this.skylight.data, (int) 0, (Object) byArray, (int) (n7 += this.blocklight.data.length), (int) this.skylight.data.length);
        ...
        for (n11 = n; n11 < n4; ++n11) {
            for (n10 = n3; n10 < n6; ++n10) {
                n9 = n11 << 11 | n10 << 7 | n2;
                n8 = n5 - n2;
                System.arraycopy((Object) this.tiles, (int) n9, (Object) byArray, (int) n7, (int) n8);
                n7 += n8;
            }
        }
        for (n11 = n; n11 < n4; ++n11) {
            for (n10 = n3; n10 < n6; ++n10) {
                ...
                n8 = (n5 - n2) / 2;
                System.arraycopy((Object) this.meta.data, (int) n9, (Object) byArray, (int) n7, (int) n8);
                n7 += n8;
            }
        }
        for (n11 = n; n11 < n4; ++n11) {
            for (n10 = n3; n10 < n6; ++n10) {
                n9 = (n11 << 11 | n10 << 7 | n2) >> 1;
                n8 = (n5 - n2) / 2;
                System.arraycopy((Object) this.blocklight.data, (int) n9, (Object) byArray, (int) n7, (int) n8);
                n7 += n8;
            }
        }
        for (n11 = n; n11 < n4; ++n11) {
            for (n10 = n3; n10 < n6; ++n10) {
                n9 = (n11 << 11 | n10 << 7 | n2) >> 1;
                n8 = (n5 - n2) / 2;
                System.arraycopy((Object) this.skylight.data, (int) n9, (Object) byArray, (int) n7, (int) n8);
                n7 += n8;
            }
        }
        return n7;
