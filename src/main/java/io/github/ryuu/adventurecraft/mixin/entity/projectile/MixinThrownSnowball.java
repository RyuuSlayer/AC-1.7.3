...
public class MixinThrownSnowball extends MixinEntity {
    ...
    private MixinLivingEntity field_1996;

    private int field_1997;

    private int field_1998 = 0;

    public MixinThrownSnowball(MixinLevel world) {
        super(world);
    ...
    public MixinThrownSnowball(MixinLevel world, MixinLivingEntity entityliving) {
        super(world);
    ...
    public MixinThrownSnowball(MixinLevel world, double d, double d1, double d2) {
        super(world);
        this.field_1997 = 0;
        this.setSize(0.25f, 0.25f);
    ...
    public void onPlayerCollision(MixinPlayer entityplayer) {
        if (this.inGround && this.field_1996 == entityplayer && this.shake <= 0 && entityplayer.inventory.pickupItem(new MixinItemInstance(ItemType.arrow, 1))) {
