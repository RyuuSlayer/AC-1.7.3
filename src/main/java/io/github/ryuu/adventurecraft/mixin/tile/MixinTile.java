...
public class MixinTile {
    ...
    protected Tile(int id, int tex, Material material) {
        this(id, material);
        this.tex = tex;
    }
    ...
    public void onTileAction(Level world, int x, int y, int z, int blockMeta, int i1) {
    }
    ...
    public void addTriggerActivation(Level world, int i, int j, int k) {
        if (this.canBeTriggered()) {
            int metadata = Math.min(world.getTileMeta(i, j, k) + 1, (int)15);
