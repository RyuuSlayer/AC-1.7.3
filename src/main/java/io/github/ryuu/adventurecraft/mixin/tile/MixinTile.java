...
import net.minecraft.tile.ButtonTile;
import net.minecraft.tile.CactusTile;
import net.minecraft.tile.CakeTile;
import net.minecraft.tile.ChestTile;
import net.minecraft.tile.ClayTile;
import net.minecraft.tile.CobwebTile;
import net.minecraft.tile.CropsTile;
import net.minecraft.tile.DeadBushTile;
import net.minecraft.tile.DetectorRailTile;
import net.minecraft.tile.DirtTile;
import net.minecraft.tile.DispenserTile;
import net.minecraft.tile.DoorTile;
import net.minecraft.tile.FarmlandTile;
...
import net.minecraft.tile.GlassTileSounds;
import net.minecraft.tile.GlowstoneTile;
import net.minecraft.tile.GrassTile;
import net.minecraft.tile.GravelTile;
import net.minecraft.tile.IceTile;
import net.minecraft.tile.JukeboxTile;
import net.minecraft.tile.LadderTile;
import net.minecraft.tile.LeavesTile;
import net.minecraft.tile.LeverTile;
import net.minecraft.tile.LockedChestTile;
import net.minecraft.tile.LogTile;
import net.minecraft.tile.MobSpawnerTile;
import net.minecraft.tile.MovingPistonTile;
import net.minecraft.tile.MushroomTile;
import net.minecraft.tile.NetherrackTile;
import net.minecraft.tile.NoteblockTile;
import net.minecraft.tile.ObsidianTile;
...
import net.minecraft.tile.PortalTile;
import net.minecraft.tile.PreciousBlockTile;
import net.minecraft.tile.PressurePlateTile;
import net.minecraft.tile.PressurePlateTrigger;
import net.minecraft.tile.PumpkinTile;
import net.minecraft.tile.RailTile;
import net.minecraft.tile.RedstoneDustTile;
import net.minecraft.tile.RedstoneOreTile;
import net.minecraft.tile.RedstoneRepeaterTile;
import net.minecraft.tile.RedstoneTorchTile;
import net.minecraft.tile.SandTile;
import net.minecraft.tile.SandTileSounds;
import net.minecraft.tile.SandstoneTile;
import net.minecraft.tile.SaplingTile;
import net.minecraft.tile.SignTile;
import net.minecraft.tile.SnowBlockTile;
import net.minecraft.tile.SnowLayerTile;
import net.minecraft.tile.SoulSandTile;
import net.minecraft.tile.SpongeTile;
import net.minecraft.tile.StairsTile;
import net.minecraft.tile.StillFluidTile;
import net.minecraft.tile.StoneSlabTile;
import net.minecraft.tile.StoneTile;
import net.minecraft.tile.SugarCane;
import net.minecraft.tile.TallGrassTile;
import net.minecraft.tile.TileSounds;
import net.minecraft.tile.TntTile;
import net.minecraft.tile.TorchTile;
import net.minecraft.tile.TrapdoorTile;
import net.minecraft.tile.WoolTile;
import net.minecraft.tile.WorkbenchTile;
...
public class MixinTile {
    ...
    public void intersectsInLevel(Level world, int i, int j, int k, Box axisalignedbb, ArrayList intersections) {
        ...
        if (axisalignedbb1 != null && axisalignedbb.intersects(axisalignedbb1)) {
            intersections.add((Object) axisalignedbb1);
        }
    }
    ...
    public void addTriggerActivation(Level world, int i, int j, int k) {
        if (this.canBeTriggered()) {
            int metadata = Math.min((int) (world.getTileMeta(i, j, k) + 1), (int) 15);
    ...
    public void removeTriggerActivation(Level world, int i, int j, int k) {
        if (this.canBeTriggered()) {
            ...
            world.method_223(i, j, k, Math.max((int) metadata, (int) 0));
            if (metadata == 0) {
    ...
    static {
        ...
        for (int i = 0; i < 256; ++i) {
            if (BY_ID[i] == null || ItemType.byId[i] != null)
                continue;
