...
public class MixinLevelProperties {
    ...
    public MixinLevelProperties(CompoundTag nbttagcompound) {
        this.useImages = true;
        this.mapSize = 250.0D;
        this.waterLevel = 64;
    ...
    public MixinLevelProperties(long l, String s) {
        this.useImages = true;
        this.mapSize = 250.0D;
        this.waterLevel = 64;
        this.fractureHorizontal = 1.0D;
    ...
    public MixinLevelProperties(LevelProperties worldinfo) {
        this.useImages = true;
        this.mapSize = 250.0D;
        this.waterLevel = 64;
        this.fractureHorizontal = 1.0D;
