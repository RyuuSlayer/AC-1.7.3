...
public abstract class MixinMinecraft implements Runnable {
    ...
    public MixinMinecraft(Component component, Canvas canvas, MinecraftApplet minecraftapplet, int i, int j, boolean flag) {
    ...
    public static void a(String s, String s1, String s2) {
        ...
        frame.addWindowListener((WindowListener) new kj((MixinMinecraft) minecraftimpl, thread));
        thread.start();
    }
