...
public class MixinTitleScreen extends Screen {
    ...
    public MixinTitleScreen() {
        ...
        try {
            ...
            BufferedReader bufferedreader = new BufferedReader(new InputStreamReader(MixinTitleScreen.class.getResourceAsStream("/title/splashes.txt"), StandardCharsets.UTF_8));
            String s = "";
            String s1;
