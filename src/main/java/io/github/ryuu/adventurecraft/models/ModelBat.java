...
public class ModelBat extends EntityModel {
    ...
    public MixinModelPart ears;

    public MixinModelPart rightWing;

    public MixinModelPart theBody;

    public MixinModelPart leftWing;
