...
public class Items {
    ...
    public static ItemType doorKey = new ItemType(201).setTexturePosition(145).setName("key");

    public static ItemHookshot hookshot = (ItemHookshot) new ItemHookshot(202).setName("hookshot").method_466();

    public static ItemType heart = new ItemType(203).setTexturePosition(146).setName("heart");

    public static ItemType heartContainer = new ItemType(204).setTexturePosition(147).setName("heartContainer");

    public static ItemType woodenShield = new ItemType(205).setTexturePosition(148).setName("woodenShield");

    public static ItemType bossKey = new ItemType(209).setTexturePosition(149).setName("bossKey");

    public static ItemType bomb = new ItemBomb(210).setName("bomb").method_466();

    public static ItemType bombArow = new ItemType(211).setTexturePosition(166).setName("bombArrow");

    public static ItemType powerGlove = new ItemPowerGlove(212).setTexturePosition(177).setName("powerGlove");

    public static ItemType heartPiece = new ItemType(213).setTexturePosition(176).setName("heartPiece");
    ...
    public static ItemType oil = new ItemType(216).setTexturePosition(181).setName("oil");
