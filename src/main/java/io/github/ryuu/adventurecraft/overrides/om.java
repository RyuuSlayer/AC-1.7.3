...
public class om extends rp {
    ...
    private void h(fd world, int i, int j, int k, int l) {
        if (m(world, i, j, k)) {
    ...
    private int b(fd world, int i, int j, int k, int l, int i1) {
        int j1 = 1000;
    ...
    private boolean[] k(fd world, int i, int j, int k) {
        for (int l = 0; l < 4; l++) {
            this.c[l] = 1000;
            int j1 = i;
            int i2 = j;
    ...
    private boolean l(fd world, int i, int j, int k) {
        int l = world.a(i, j, k);
    ...
    protected int f(fd world, int i, int j, int k, int l) {
    ...
    private boolean m(fd world, int i, int j, int k) {
