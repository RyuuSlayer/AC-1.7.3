...
public class GuiStorage extends MixinScreen {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.drawTextWithShadow(this.textManager, String.format("Min: (%d, %d, %d)", new Object[]{this.storage.minX, this.storage.minY, this.storage.minZ}), 4, 4, 0xE0E0E0);
        this.drawTextWithShadow(this.textManager, String.format("Max: (%d, %d, %d)", new Object[]{this.storage.maxX, this.storage.maxY, this.storage.maxZ}), 4, 24, 0xE0E0E0);
