...
public class GuiTimer extends da {
    ...
    public void b() {
        ...
        this.e.add(b);
        if (!this.useTextFields) {
            this.delayTime = new GuiSlider2(4, 4, 80, 10, String.format("Delay for: %.2fs", Float.valueOf(this.timer.timeDelay / 20.0F)), this.timer.timeDelay / 20.0F / 60.0F);
            this.e.add(this.delayTime);
            this.activeTime = new GuiSlider2(2, 4, 100, 10, String.format("Active for: %.2fs", Float.valueOf(this.timer.timeActive / 20.0F)), this.timer.timeActive / 20.0F / 60.0F);
            this.e.add(this.activeTime);
            this.deactiveTime = new GuiSlider2(3, 4, 120, 10, String.format("Deactive for: %.2fs", Float.valueOf(this.timer.timeDeactive / 20.0F)), this.timer.timeDeactive / 20.0F / 60.0F);
