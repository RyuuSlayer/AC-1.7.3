...
public class GuiTrigger extends da {
    ...
    public GuiTrigger(fd w, int x, int y, int z, TileEntityTrigger triggerClicked) {
        this.world = w;
        this.blockX = x;
        this.blockY = y;
        this.blockZ = z;
    ...
    public static void showUI(fd w, int x, int y, int z, TileEntityTrigger triggerClicked) {
