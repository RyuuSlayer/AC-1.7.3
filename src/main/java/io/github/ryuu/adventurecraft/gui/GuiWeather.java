...
public class GuiWeather extends Screen {
    ...
    public GuiWeather(Level level, TileEntityWeather weather) {
        this.weather = weather;
    }

    public static void showUI(Level level, TileEntityWeather w) {
        AccessMinecraft.getInstance().openScreen(new GuiWeather(level, w));
    }
    ...
    protected void buttonClicked(Button button) {
        if (button.id == 0) {
            ...
            } else if (this.weather.changePrecipitate) {
        ...
        if (button.id == 7) {
            ...
            } else if (this.weather.changeThundering) {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.weather.tempOffset = this.tempOffset.sliderValue * 2.0 - 1.0;
