...
public class GuiNpcPath extends MixinScreen {
    ...
    public void init() {
        ...
        this.buttons.add((Object) new OptionButton(0, 4, 20, String.format("Set Path NPC: %s", new Object[]{entityName})));
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.drawTextWithShadow(this.textManager, String.format("NPC: %s", new Object[]{entityName}), 4, 4, 0xE0E0E0);
        this.drawTextWithShadow(this.textManager, String.format("Min: (%d, %d, %d)", new Object[]{this.path.minX, this.path.minY, this.path.minZ}), 4, 44, 0xE0E0E0);
        this.drawTextWithShadow(this.textManager, String.format("Max: (%d, %d, %d)", new Object[]{this.path.maxX, this.path.maxY, this.path.maxZ}), 4, 64, 0xE0E0E0);
