...
public class GuiMusic extends Screen {
    ...
    public void b() {
        ...
        this.fadeOut = new GuiSlider2(200, 4, 16, 10, String.format("Fade Out: %d", new Object[] { Integer.valueOf(this.music.fadeOut) }), this.music.fadeOut / 5000.0F);
        this.fadeIn = new GuiSlider2(201, this.c / 2, 16, 10, String.format("Fade In: %d", new Object[] { Integer.valueOf(this.music.fadeIn) }), this.music.fadeIn / 5000.0F);
